...
const td3text = document.createTextNode("ISEP");
const td4text = document.createTextNode("Porto");
...
// document.body.appendChild(table);   → Creates the table with the addicional content